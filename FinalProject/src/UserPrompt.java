...
public static void question1(ArrayList<TeamRoster> teams) {
	...
	if (answer1.equals( teams.get(j).name)) {
		...
		System.out.println("Attack: "+att1 + "  " +"Middle: "+ mid1 + "  "+"Defense: " + def1);
		//Call question2.
		question2(teams);
	}
/**
 ...
 */
	public static void question2(ArrayList<TeamRoster> teams) {
		...
		System.out.println("Attack: "+att2 + "  "+"Middle: " + mid2 + "  "+"Defense:" + def2);
	 ...
	 */
	 ...
	 /**
	  * A method to ask the fourth question and provide options for user to choose.
	  * @param console The Scanner object to use for user input.
	  * @param teams The ArrayList object to store input variables.
	  */
