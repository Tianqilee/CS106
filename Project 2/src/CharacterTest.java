...
/**
 * @author Tianqi Li A program to test which monarch you are more like in the
 *         Three Kingdoms Period and which types of leader you are in reality.
 */
public class CharacterTest {

	/**
	 * The main method to declare variables and scanner and then initiated
	 * question1 method
	 * 
	 * @param args
	 */
	 ...
	 * @param disruptive
	 *            The disruptive tracking variable
	 * @param incremental
	 *            The disruptive tracking variable
	 */
	...
	public static void question2(Scanner console, int disruptive,
		...
		System.out.println("A.Travel by yourself.");
		System.out.println("B.Travel with lots of friends.");
		System.out.println("What is your answer?");
		// Record the answer to the string
		String answer1 = console.nextLine();
		// While loop gives the user a hint to type the answer
	...
	public static void question3(Scanner console, int disruptive,
		...
		System.out.println("Question3:If one of your wishes below can become true, which one will you choose? ");
	...
	public static void question4(Scanner console, int disruptive,
		...
		System.out.println("Question4:You have checked your monthly balance, and there is still some money. What will you do?");
	...
	public static void question7(Scanner console, int disruptive,
		...
		System.out.println("Question 7: Your boss askes you and a person who you don't like to be partners. Which action below will you choose to take?");
	 ...
	 *            The disruptive tracking variable
	 * @param incremental
	 *            The incremental tracking variable
	 */
	public static void getResults(int disruptive, int incremental) {
		...
		if (disruptive > incremental && disruptive >= 6) {
			System.out
					.println("You are Cao Cao, the monarch of Wei. "
			...
			System.out
					.println("You are Yi Sima, the monarch of Jin."
			...
			System.out
					.println("You are Bei Liu, the monarch of Shu. You are a very considerate person and you always think of others at first. "
			...
			System.out
					.println("You are Quan Sun, the monarch of Wu. "
