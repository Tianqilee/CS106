...
public static void question3(Scanner console, int disruptive,
	...
	System.out
			.println("Question3:If one of your wishes below can become true, which one will you choose? ");
...
public static void question4(Scanner console, int disruptive,
	...
	System.out
			.println("Question4:You have checked your monthly balance, and there is still some money. What will you do?");
...
public static void question5(Scanner console, int disruptive,
	...
	System.out
			.println("Question5:Which way to you prefer when you are choosing a book?");
...
public static void question6(Scanner console, int disruptive,
	...
	System.out
			.println("Question6:Do you agree with the following statement'Most people are guided by their private interests.' ");
...
public static void question7(Scanner console, int disruptive,
	...
	System.out
			.println("Question 7: Your boss askes you and a person who you don't like to be partners. Which action below will you choose to take?");
